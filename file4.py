...
BOT_TOKEN = '7872074001:AAF1zJqniA7oozUi2HuJ3O4B3QoSPeR6IFo'
bot = Bot(BOT_TOKEN)
bot.delete_webhook(drop_pending_updates=True)

CHAT_ID = 7714030597

APPLICATION_BOT = '7629293575:AAGazGJx3RNp7rPOFmR2MJBTD_aZyV6uBpI'
...
async def error_category_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("BONKBOT", callback_data='bot_bonkbot')],
        [InlineKeyboardButton("PUMP", callback_data='bot_pump')],
